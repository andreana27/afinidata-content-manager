...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('author', 'author'), ('reviser', 'reviser')], default='author', max_length=20)),
        ...
        migrations.AddField(
            model_name='review',
            name='users',
            field=models.ManyToManyField(through='posts.UserReviewRole', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Response',
            fields=[
