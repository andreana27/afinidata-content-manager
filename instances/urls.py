...
urlpatterns = [
    ...
    path('<int:instance_id>/milestones_list/', views.ProgramMilestonesListView.as_view(), name='milestones_list'),
    ...
    path('<int:instance_id>/program_milestones/', views.ProgramInstanceMilestonesView.as_view(),
         name='instance_program_milestones'),
